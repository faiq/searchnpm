...
exports.seachDefault = function(searchObj){ 
  var queryObj = {}
  queryObj.dis_max = {
    tie_breaker : 0.7,
    boost : 1.2,
  ...
  //make a temp search obj with no sort field to make subqueries
  var tempSO = {}
  extend(tempSO, searchObj) 
  tempSO.sortBy = 'relevance'       
  //rank by name 
  var nameQuery = exports.searchPackageName(tempSO)
  //rank by downloads 
